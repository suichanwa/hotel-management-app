...
data:extend({
    ...
    },
    {
        ...
        localised_name = {"recipe-name.high-plutonium-fuel-cell"},
        enabled = false,
        category = "centrifuging",
        energy_required = 10,
        ingredients = {
        ...
        results = {
            {type = "item", name = "high-plutonium-fuel-cell", amount = 10}
        }
    },
    {
        type = 'recipe',
        name = 'high-plutonium-fuel-cell-reprocessing',
        localised_name = { 'recipe-name.high-plutonium-fuel-cell-reprocessing' },
        icon = '__PlutoniumEnergy__/graphics/icons/high-plutonium-fuel-cell.png',
        icon_size = 64,
        icon_mipmaps = 4,
        category = 'centrifuging',
        subgroup = 'intermediate-product',
        order = 'r[uranium-processing]-h[high-plutonium-reprocessing]',
        enabled = false,
        energy_required = 60,
        ingredients = {
            { type = 'item', name = 'depleted-high-plutonium-fuel-cell', amount = 20 }
        },
        results = {
    ...
    },
    {
        ...
        localised_name = {"recipe-name.compact-pu238-fuel-cell"},
        ...
        ingredients = {
            ...
            { type = "item", name = "plutonium-238", amount = 3 }
        },
        results = { { type = "item", name = "compact-pu238-fuel-cell", amount = 18 } },
        subgroup = "nuclear-plutonium",
        order = "r[uranium-processing]-e[compact-pu238-fuel-cell]",
    },
    {
        type = "recipe",
        name = "compact-pu238-fuel-cell-reprocessing",
        localised_name = {"recipe-name.compact-pu238-fuel-cell-reprocessing"},
        energy_required = 50,
        enabled = false,
        allow_productivity = true,
        category = "centrifuging",
        ingredients = {
            { type = "item", name = "depleted-compact-pu238-fuel-cell", amount = 30 }
        },
        icons = reprocessing_icon(
            '__PlutoniumEnergy__/graphics/icons/deepleted-compact-fuel-cell.png',
            { 0, 1, 1, 1 }, 0.75
        ),
        icon_size = 64,
        icon_mipmaps = 4,
        subgroup = "nuclear-plutonium",
        order = "r[uranium-processing]-c[reprocessing]-e[compact-pu238]",
        main_product = "",
        crafting_machine_tint = {
            primary = { r = 0.000, g = 1.000, b = 0.961, a = 1.000 } -- #00FFF5
        },
    ...
    },
    {
        ...
        localised_name = {"recipe-name.advanced-plutonium-mixture"},
        energy_required = 30,
        enabled = false,
        allow_productivity = true,
        category = "centrifuging",
        ingredients = {
            ...
            { type = "item", name = "plutonium-239", amount = 2 },
            { type = "item", name = "plutonium-238", amount = 9 },
            { type = "item", name = "iron-plate", amount = 10 }
        },
        results = {
            { type = "item", name = "advanced-plutonium-mixture", amount = 2 }
        },
        subgroup = "intermediate-product",
        order = "r[uranium-processing]-f[advanced-plutonium-mixture]",
        crafting_machine_tint = {
            primary = { r = 0.2, g = 0.8, b = 1.0, a = 1.000 }
        },
        allow_decomposition = false
    },
    {
        ...
        localised_name = {"recipe-name.uranium-enriched-high-plutonium-fuel-cell"},
        energy_required = 60,
        enabled = false,
        allow_productivity = true,
        category = "centrifuging",
        ...
        results = { { type = "item", name = "uranium-enriched-high-plutonium-fuel-cell", amount = 4 } },
        subgroup = "nuclear-plutonium",
    ...
    {
        type = "recipe",
        name = "uranium-enriched-high-plutonium-fuel-cell-reprocessing",
        localised_name = {"recipe-name.uranium-enriched-high-plutonium-fuel-cell-reprocessing"},
        energy_required = 50,
        enabled = false,
        allow_productivity = true,
        category = "centrifuging",
        ingredients = {
            { type = "item", name = "depleted-uranium-enriched-high-plutonium-fuel-cell", amount = 4 }
        },
        icon = "__PlutoniumEnergy__/graphics/icons/uranium-enriched-plutonium-reprocessing.png",
        icon_size = 64,
        icon_mipmaps = 4,
        subgroup = "nuclear-plutonium",
        order = "r[uranium-processing]-c[reprocessing]-f[uranium-enriched-high-plutonium]",
        main_product = "",
        crafting_machine_tint = {
            primary = { r = 0.000, g = 1.000, b = 0.961, a = 1.000 } -- #00FFF5
        },
