...
data:extend({
    ...
    },
    {
        ...
        effects = {
            ...
            {
                type = "unlock-recipe",
                recipe = "compact-pu238-fuel-cell"
            }
        },
        prerequisites = { "plutonium-processing" },
        unit = {
    ...
    },
    {
        ...
        effects = {
            ...
            {
                type = "unlock-recipe",
                recipe = "compact-pu238-fuel-cell-reprocessing"
            },
            {
                type = "unlock-recipe",
                recipe = "uranium-enriched-high-plutonium-fuel-cell-reprocessing"
            },
        },
    ...
    {
        type = "technology",
        name = "high-plutonium-nuclear-power",
        icon = "__PlutoniumEnergy__/graphics/technology/high-plutonium-nuclear-power.png",
        icon_size = 256,
        icon_mipmaps = 4,
        effects = {
            {
                type = "unlock-recipe",
                recipe = "high-plutonium-fuel-cell"
            },
            {
                type = "unlock-recipe",
                recipe = "high-plutonium-fuel-cell-reprocessing"
            }
        },
        prerequisites = { "plutonium-nuclear-power", "kovarex-enrichment-process" },
        unit = {
