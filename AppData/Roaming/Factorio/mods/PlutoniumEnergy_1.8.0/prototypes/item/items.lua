...
data:extend({
    ...
    {
        type = "item",
        name = "high-plutonium-fuel-cell",
        localised_name = {"item-name.high-plutonium-fuel-cell"},
        localised_description = {"item-description.high-plutonium-fuel-cell"},
        icon = "__PlutoniumEnergy__/graphics/icons/high-plutonium-fuel-cell.png",
        icon_size = 64,
        icon_mipmaps = 4,
        pictures = {
            layers = {
                {
                    size = 64,
                    filename = "__PlutoniumEnergy__/graphics/icons/high-plutonium-fuel-cell.png",
                    scale = 0.5,
                    mipmap_count = 4,
                },
                {
        ...
        subgroup = "nuclear-plutonium",
        order = "r[uranium-processing]-d[high-plutonium-fuel-cell]",
        inventory_move_sound = item_sounds.nuclear_inventory_move,
        pick_sound = item_sounds.nuclear_inventory_pickup,
        drop_sound = item_sounds.nuclear_inventory_move,
        fuel_category = "MOX",
        burnt_result = "depleted-high-plutonium-fuel-cell",
        fuel_value = "6.35GJ",
        fuel_glow_color = { 0, 1, 1, 0 },
        stack_size = 50,
        weight = 100 * kg
    ...
    {
        type = "item",
        name = "depleted-high-plutonium-fuel-cell",
        icon = "__PlutoniumEnergy__/graphics/icons/depleted-high-plutonium-fuel-cell.png",
        icon_size = 64,
        icon_mipmaps = 4,
        subgroup = "nuclear-plutonium",
        order = "u[depleted-high-plutonium-fuel-cell]",
        inventory_move_sound = item_sounds.nuclear_inventory_move,
        pick_sound = item_sounds.nuclear_inventory_pickup,
        drop_sound = item_sounds.nuclear_inventory_move,
        stack_size = 50,
    ...
    {
        type = "item",
        name = "compact-pu238-fuel-cell",
        localised_name = {"item-name.compact-pu238-fuel-cell"},
        localised_description = {"item-description.compact-pu238-fuel-cell"},
        icon = "__PlutoniumEnergy__/graphics/icons/compact-fuel-cell.png",
        icon_size = 64,
        icon_mipmaps = 4,
        pictures = {
            layers = {
                {
                    size = 64,
                    filename = "__PlutoniumEnergy__/graphics/icons/compact-fuel-cell.png",
                    scale = 0.5,
                    mipmap_count = 4,
                },
                {
        ...
        subgroup = "nuclear-plutonium",
        order = "r[uranium-processing]-e[compact-pu238-fuel-cell]",
        inventory_move_sound = item_sounds.nuclear_inventory_move,
        pick_sound = item_sounds.nuclear_inventory_pickup,
        drop_sound = item_sounds.nuclear_inventory_move,
        fuel_category = "MOX",
        burnt_result = "depleted-compact-pu238-fuel-cell",
        fuel_value = "1.4GJ",
        fuel_glow_color = { 0, 1, 1, 0 },
        stack_size = 100,
        weight = 50 * kg
    ...
    {
        type = "item",
        name = "depleted-compact-pu238-fuel-cell",
        localised_name = {"item-name.depleted-compact-pu238-fuel-cell"},
        localised_description = {"item-description.depleted-compact-pu238-fuel-cell"},
        icon = "__PlutoniumEnergy__/graphics/icons/deepleted-compact-fuel-cell.png",
        icon_size = 64,
        icon_mipmaps = 4,
        subgroup = "nuclear-plutonium",
        order = "v[depleted-compact-pu238-fuel-cell]",
        inventory_move_sound = item_sounds.nuclear_inventory_move,
        pick_sound = item_sounds.nuclear_inventory_pickup,
        drop_sound = item_sounds.nuclear_inventory_move,
        stack_size = 100,
    ...
    {
        type = "item",
        name = "uranium-enriched-high-plutonium-fuel-cell",
        localised_name = {"item-name.uranium-enriched-high-plutonium-fuel-cell"},
        localised_description = {"item-description.uranium-enriched-high-plutonium-fuel-cell"},
        icon = "__PlutoniumEnergy__/graphics/icons/uranium-enriched-high-plutonium-fuel-cell.png",
        icon_size = 64,
        icon_mipmaps = 4,
        pictures = {
            layers = {
                {
                    size = 64,
                    filename = "__PlutoniumEnergy__/graphics/icons/uranium-enriched-high-plutonium-fuel-cell.png",
                    scale = 0.5,
                    mipmap_count = 4,
                },
                {
        ...
        subgroup = "nuclear-plutonium",
        order = "r[uranium-processing]-f[uranium-enriched-high-plutonium-fuel-cell]",
        inventory_move_sound = item_sounds.nuclear_inventory_move,
        pick_sound = item_sounds.nuclear_inventory_pickup,
        drop_sound = item_sounds.nuclear_inventory_move,
        fuel_category = "nuclear",
        burnt_result = "depleted-uranium-enriched-high-plutonium-fuel-cell",
        fuel_value = "37GJ",
        fuel_glow_color = { 0, 1, 1, 0 },
        stack_size = 50,
        weight = 100 * kg
    ...
    {
        type = "item",
        name = "depleted-uranium-enriched-high-plutonium-fuel-cell",
        localised_name = {"item-name.depleted-uranium-enriched-high-plutonium-fuel-cell"},
        localised_description = {"item-description.depleted-uranium-enriched-high-plutonium-fuel-cell"},
        icon = "__PlutoniumEnergy__/graphics/icons/uranium-enriched-high-plutonium-fuel-cell-deepleted.png",
        icon_size = 64,
        icon_mipmaps = 4,
        subgroup = "nuclear-plutonium",
        order = "w[depleted-uranium-enriched-high-plutonium-fuel-cell]",
        inventory_move_sound = item_sounds.nuclear_inventory_move,
        pick_sound = item_sounds.nuclear_inventory_pickup,
        drop_sound = item_sounds.nuclear_inventory_move,
        stack_size = 50,
    ...
    {
        type = "item",
        name = "advanced-plutonium-mixture",
        localised_name = {"item-name.advanced-plutonium-mixture"},
        localised_description = {"item-description.advanced-plutonium-mixture"},
        icon = "__PlutoniumEnergy__/graphics/icons/plutonium-239.png",
        icon_size = 64,
        icon_mipmaps = 4,
        subgroup = "intermediate-product",
        order = "r[uranium-processing]-f[advanced-plutonium-mixture]",
        inventory_move_sound = item_sounds.nuclear_inventory_move,
        pick_sound = item_sounds.nuclear_inventory_pickup,
        drop_sound = item_sounds.nuclear_inventory_move,
        stack_size = 50,
